...
export const metadata: Metadata = {
  ...
  description:
    'GenSeed Capital invests 50% in longevity science and 50% in the space economy — two sectors at generational inflection points. Explore our thesis.',
  openGraph: {
    title: 'Investment Focus | GenSeed Capital',
    description:
