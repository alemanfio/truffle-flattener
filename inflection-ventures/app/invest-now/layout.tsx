...
export const metadata: Metadata = {
  title: 'Invest Now',
  description:
    'Invest in GenSeed Capital Fund I from €10,000. Longevity & space economy VC. ELTIF 2.0 regulated. Learn about eligibility, fees, and the 5-step process.',
  openGraph: {
    title: 'Invest Now | GenSeed Capital',
    description:
